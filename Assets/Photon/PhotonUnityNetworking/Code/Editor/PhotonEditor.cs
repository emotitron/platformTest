...
namespace Photon.Pun
{
    ...
    public class PhotonEditor : EditorWindow
    {
        ...
        protected virtual void UiMainWizard()
        {
            ...
            EditorGUILayout.BeginVertical(new GUIStyle() { padding = new RectOffset(10, 10, 10, 10) }/*, GUILayout.MaxWidth(EditorGUIUtility.currentViewWidth)*/);

            // wizard info text
            EditorGUILayout.HelpBox(CurrentLang.WizardMainWindowInfo, MessageType.None);
            GUILayout.Space(15);
