...
namespace emotitron.Compression.Internal
{
	...
	public static class PackObjectDatabase
	{
		...
		public static PackObjectInfo GetPackObjectInfo(Type type)
		{
			...
			if (packType != null)
			{
				Debug.Log("BRUTE FORCE Pack_" + type.Name);
			...
			Debug.LogWarning("PackObject code has not been generated for type '" + type.Name + "'. Is Code Generation disabled in " + typeof(emotitron.Networking.SimpleSyncSettings).Name + "?");
			return null;
		}
