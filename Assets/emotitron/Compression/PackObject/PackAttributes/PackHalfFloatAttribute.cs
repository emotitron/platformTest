...
{
	public class PackHalfFloatAttribute : PackBaseAttribute, IPackSingle, IPackDouble
	{

		private readonly IndicatorBit indicatorBit;

		// Constructor
		public PackHalfFloatAttribute(IndicatorBit indicatorBit = IndicatorBit.None, KeyRate keyRate = KeyRate.UseDefault)
		{
