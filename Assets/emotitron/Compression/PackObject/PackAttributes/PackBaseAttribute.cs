...
using emotitron.Utilities.Reflection;
using System;
...
namespace emotitron.Compression.Internal
{
	...
	public abstract class PackBaseAttribute : Attribute
	{
		...
		/// <summary>
		/// By default the callback is called After the value is changed. This behaviour can be changed by setting the CallbackSetValue.
		/// </summary>
		...
		///// <summary>
		///// Types that support extrapolation will extraplate by this much each tick on buffer underruns. 0 = none. 1 = endless.
		///// </summary>
