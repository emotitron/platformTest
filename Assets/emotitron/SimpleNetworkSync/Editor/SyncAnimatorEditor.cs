...
namespace emotitron.Networking
{
	...
	public class SyncAnimatorEditor : SyncObjectTFrameEditor
	{
		...
		protected override string HelpURL
		{
			get
			{
				return "https://docs.google.com/document/d/1ySmkOBsL0qJnIk7iN9lbXPlfmYTGkN7JFgKDBdqj9e8/edit#bookmark=id.irhfiqscyynv";
			}
		}
		...
		protected override string TextTexturePath
		{
			get
			{
				return "Header/SyncAnimatorText";
			}
		}
